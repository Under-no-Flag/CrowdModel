        ...
        rows.append(
            {
                ...
                "j1_normalized": case.get("j1_normalized", 0.0),
                "j2_normalized": case.get("j2_normalized", 0.0),
                "j5_normalized": case.get("j5_normalized", 0.0),
            ...
            handle.write(
                ...
                + " | ".join(
                    [
                        ...
                        f'{row["j1_normalized"]:.4f}',
                        f'{row["j2_normalized"]:.4f}',
                        f'{row["j5_normalized"]:.4f}',
