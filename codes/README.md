...
- `python codes/g4_runner.py`
  Runs the G4 optimization batch. The default config now runs the minimal comparison matrix `baseline / random_search / grid_search / pure_sa / SA-HBO w/o proxy / SA-HBO` in separate worker processes for `z=(s, eta)` with fixed behavior parameter `p_hat`, then aggregates iteration logs, evaluation CSV, and method-comparison outputs.
- `python codes/visualize_g4_results.py --output-root codes/results/g4_minimal_matrix`
...
- `python codes/g4_runner.py --config codes/scenes/examples/g4_sahbo_vs_grid/g4.toml --mode matrix --steps 600 --time-horizon 40`
- `python codes/g4_runner.py --config codes/scenes/examples/g4_sahbo_vs_grid/g4.toml --mode matrix --workers 3`
- `python codes/g4_runner.py --config codes/scenes/examples/g4_sahbo_vs_grid/g4.toml --mode random_search --random-max-evals 20`
- `python codes/visualize_g4_results.py --output-root codes/results/g4_minimal_matrix`
