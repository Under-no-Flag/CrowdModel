...
```bash
python .copilot/skills/tikz/scripts/render_tikz.py <path-to-tex-file>
```
...
adjust font size, reposition elements, etc.), then re-render:
  python .copilot/skills/tikz/scripts/render_tikz.py <tex-path>
...
python .copilot/skills/tikz/scripts/submit_temp.py <path-to-file>

# Symlink instead of copy (good for large files or live-editing)
python .copilot/skills/tikz/scripts/submit_temp.py --link <path>

# Symlink a directory
python .copilot/skills/tikz/scripts/submit_temp.py --link /path/to/docs/

# Custom name
python .copilot/skills/tikz/scripts/submit_temp.py --name translated.md <path>
```
...
```bash
python .copilot/skills/tikz/scripts/ensure_server.py --stop
```
