...
Under five random seeds and unified high-fidelity rechecking, HCMBO obtains the lowest mean full management objective among the tested baselines, reducing the fixed-weight score by 3.9\% relative to TPE-Mixed BO and maintaining a 100\% feasible rate.
...
In that experiment, the reduced objective decreases by 26.9\%, mainly because the policy redistributes flow away from the dominant terminal channel and improves load balance across the middle-channel group.
